        ...
        <div class="boardWrap">
            ...
            <form name="boardF" action="../user/write" method="post"
                ...
                <ul class="boardUl">
                    ...
                    <li>글쓴이</li>
                    <li>
                        <input type="text" name="userId" id="userId" readonly placeholder="User ID" value="${loginUser.userId}">
                    </li>

                    <li>글내용</li>
                    <li>
                        <textarea rows="10" cols="50" name="content" id="content" placeholder="Content"></textarea>
                    </li>
